...
class TestCreateContainers:
    ...
    def test_create_containers_success(self, mock_images_repo, mock_containers_repo, mock_docker, mock_kafka):
        ...
        mock_docker.run_container.return_value = (mock_docker_container, 8080, "172.17.0.2")
        ...
        result = create_containers(db, image_id=1, user_id=1, container_data=container_data)
    ...
    def test_create_containers_image_not_found(self, mock_images_repo):
        ...
        with pytest.raises(HTTPException) as exc_info:
            create_containers(db, image_id=999, user_id=1, container_data=container_data)
...
class TestStartContainer:
    ...
    @patch('app.application.services.container_service.docker_service')
    @patch('app.application.services.container_service.containers_repository')
    def test_start_container_success(self, mock_containers_repo, mock_docker, mock_images_repo, mock_kafka):
...
class TestStopContainer:
    ...
    @patch('app.application.services.container_service.docker_service')
    @patch('app.application.services.container_service.containers_repository')
    def test_stop_container_success(self, mock_containers_repo, mock_docker, mock_images_repo, mock_kafka):
...
class TestDeleteContainer:
    ...
    @patch('app.application.services.container_service.docker_service')
    @patch('app.application.services.container_service.containers_repository')
    def test_delete_container_success(self, mock_containers_repo, mock_docker, mock_images_repo, mock_kafka):
