...
class TestProxyServiceExtended:
    ...
    @pytest.mark.asyncio
    async def test_proxy_to_container_502_error_invalidates_cache(self, mock_http_client, cache):
    ...
    @pytest.mark.asyncio
    async def test_proxy_to_container_503_error_invalidates_cache(self, mock_http_client, cache):
    ...
    @pytest.mark.asyncio
    async def test_proxy_to_container_4xx_does_not_invalidate_cache(self, mock_http_client, cache):
