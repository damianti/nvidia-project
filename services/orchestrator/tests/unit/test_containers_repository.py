...
class TestContainersRepository:
    ...
    def test_get_by_id_and_user_found(self):
        ...
        result = containers_repository.get_by_id_and_user(mock_db, container_id=1, user_id=1)
    ...
    def test_get_by_id_and_user_not_found(self):
        ...
        result = containers_repository.get_by_id_and_user(mock_db, container_id=999, user_id=1)
    ...
    def test_list_by_user(self):
        ...
        mock_query = Mock()
        mock_filter = Mock()
        mock_containers = [Mock(spec=Container), Mock(spec=Container), Mock(spec=Container)]
    ...
    def test_list_by_image_and_user(self):
        ...
        result = containers_repository.list_by_image_and_user(mock_db, image_id=1, user_id=1)
    ...
    def test_list_by_image_and_user_empty(self):
        ...
        result = containers_repository.list_by_image_and_user(mock_db, image_id=999, user_id=1)
