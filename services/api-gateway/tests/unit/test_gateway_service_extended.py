...
class TestGatewayServiceExtended:
    ...
    async def test_handle_route_request_success(
        ...
        with patch("app.services.gateway_service.resolve_route", return_value=entry), \
             patch("app.services.gateway_service.proxy_to_container", return_value=mock_proxy_response) as mock_proxy, \
