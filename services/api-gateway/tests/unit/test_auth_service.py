...
class TestAuthService:
    ...
    async def test_handle_login_success(self, mock_auth_client, mock_response):
        ...
        result = await auth_service.handle_login(login_data, mock_auth_client, mock_response)
    ...
    async def test_handle_signup_success(self, mock_auth_client, mock_response):
        ...
        result = await auth_service.handle_signup(user_data, mock_auth_client, mock_response)
