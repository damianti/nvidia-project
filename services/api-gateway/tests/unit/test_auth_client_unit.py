...
class TestAuthClientUnit:
    ...
    async def test_login_happy_path(
        self, auth_client: AuthClient, mock_http_client: AsyncMock
    ) -> None:
    ...
    async def test_login_invalid_credentials(
        ...
        assert (
            ...
            or "credentials" in response_data["detail"].lower()
    ...
    async def test_logout_happy_path(
        ...
        # Act
        response = await auth_client.logout(
            "test-token", {"access_token": "test-token"}
        )
    ...
    def test_build_headers_with_correlation_id(self, auth_client: AuthClient) -> None:
