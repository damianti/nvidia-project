"""
Logging configuration for service-discovery service.
...
def setup_logger(service_name: str) -> logging.Logger:
    ...
    try:
        log_level_str = _validate_log_level(log_level_str)
        log_level = getattr(logging, log_level_str)
    except (ValueError, AttributeError) as e:
        # Fallback to INFO if invalid
        print(f"Warning: Invalid LOG_LEVEL '{log_level_str}', using INFO. Error: {e}")
