...
@router.post(
    ...
    summary="Create containers from an image",
)
...
@router.post(
    "/{id}/start", response_model=ContainerResponse, summary="Start a stopped container"
)
...
@router.post(
    "/{id}/stop", response_model=ContainerResponse, summary="Stop a running container"
)
