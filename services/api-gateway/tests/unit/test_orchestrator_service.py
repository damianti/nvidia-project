...
class TestOrchestratorService:
    ...
    @pytest.mark.asyncio
    async def test_handle_image_upload_success(self, mock_orchestrator_client, mock_upload_file):
    ...
    @pytest.mark.asyncio
    async def test_handle_orchestrator_proxy_multipart_empty_body(self, mock_orchestrator_client):
    ...
    @pytest.mark.asyncio
    async def test_handle_orchestrator_proxy_multipart_stream_error(self, mock_orchestrator_client):
