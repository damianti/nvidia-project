...
class TestImagesEndpoints:
    ...
    def test_create_image_invalid_data(
        self, invalid_image_data: Dict[str, Any], sample_image_file: tuple
    ) -> None:
    ...
    def test_list_images_success(self, mock_get_all: Mock, test_user_id: int) -> None:
    ...
    def test_get_image_success(self, mock_get_image: Mock, test_user_id: int) -> None:
    ...
    @patch("app.api.images.image_service.get_image_by_id")
    def test_get_image_not_found(self, mock_get_image: Mock) -> None:
    ...
    @patch("app.api.images.image_service.get_image_by_id")
    def test_get_image_build_logs_success(self, mock_get_image: Mock) -> None:
        ...
        response_data = response.json()
        assert (
            "build_logs" in response_data
        ), "Response should contain 'build_logs' field"
        assert isinstance(
            response_data["build_logs"], str
        ), "build_logs should be a string"
    ...
    def test_delete_image_success(self, mock_delete: Mock) -> None:
    ...
    @patch("app.api.images.image_service.delete_image")
    def test_delete_image_not_found(self, mock_delete: Mock) -> None:
